...
export type CreateInboundIpRequest = {
    /**
     * This setting allows you to set the format with which the caller's number (ANI) is sent for inbound phone calls.
     */
    ani_number_format?: CreateInboundIpRequest.ani_number_format;
    dnis_number_format?: CreateInboundIpRequest.dnis_number_format;
    /**
     ...
     */
    default_routing_method?: CreateInboundIpRequest.default_routing_method;
    /**
     ...
     */
    sip_region?: CreateInboundIpRequest.sip_region;
    /**
     ...
     */
    sip_subdomain_receive_settings?: CreateInboundIpRequest.sip_subdomain_receive_settings;
    /**
...
export namespace CreateInboundIpRequest {
