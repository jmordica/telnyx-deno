...
export class ListVerifiedCallsDisplayProfilesResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<VerifiedCallsDisplayProfile>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return ListVerifiedCallsDisplayProfilesResponse.attributeTypeMap;
    }
