...
export class ListPortingOrderRequirements200Response {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<PortingOrderRequirementDetail>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return ListPortingOrderRequirements200Response.attributeTypeMap;
    }
