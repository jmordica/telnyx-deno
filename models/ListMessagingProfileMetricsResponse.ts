...
export class ListMessagingProfileMetricsResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<MessagingProfileHighLevelMetrics>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return ListMessagingProfileMetricsResponse.attributeTypeMap;
    }
