...
export class ListMessagingHostedNumberOrderResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<MessagingHostedNumberOrder>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return ListMessagingHostedNumberOrderResponse.attributeTypeMap;
    }
