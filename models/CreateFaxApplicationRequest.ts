...
export type CreateFaxApplicationRequest = {
    ...
    inbound?: {
         ...
         */
        sip_subdomain_receive_settings?: CreateFaxApplicationRequest.sip_subdomain_receive_settings;
    };
    outbound?: {
        /**
...
export namespace CreateFaxApplicationRequest {
