...
export class ListPhoneNumbersWithVoiceSettingsResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<PhoneNumberWithVoiceSettings>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return ListPhoneNumbersWithVoiceSettingsResponse.attributeTypeMap;
    }
