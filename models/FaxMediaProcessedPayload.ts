...
export class FaxMediaProcessedPayload {
    /**
    ...
    */
    'status'?: FaxMediaProcessedPayloadStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "FaxMediaProcessedPayloadStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return FaxMediaProcessedPayload.attributeTypeMap;
    }
...
export type FaxMediaProcessedPayloadStatusEnum = "media.processed" ;
