...
export class FindNotificationsEventsConditions200Response {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<NotificationEventCondition>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return FindNotificationsEventsConditions200Response.attributeTypeMap;
    }
