...
export class FaxQueuedPayload {
    ...
    */
    'status'?: FaxQueuedPayloadStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "FaxQueuedPayloadStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return FaxQueuedPayload.attributeTypeMap;
    }
...
export type FaxQueuedPayloadStatusEnum = "queued" ;
