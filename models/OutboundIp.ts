...
export type OutboundIp = {
     ...
     */
    ani_override_type?: OutboundIp.ani_override_type;
    /**
     ...
     */
    t38_reinvite_source?: OutboundIp.t38_reinvite_source;
    /**
     * Numerical chars only, exactly 4 characters.
     */
    tech_prefix?: string;
    ip_authentication_method?: OutboundIp.ip_authentication_method;
...
export namespace OutboundIp {
    ...
    export enum ip_authentication_method {
