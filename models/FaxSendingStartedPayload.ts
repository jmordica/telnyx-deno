...
export class FaxSendingStartedPayload {
    /**
    ...
    */
    'status'?: FaxSendingStartedPayloadStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "FaxSendingStartedPayloadStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return FaxSendingStartedPayload.attributeTypeMap;
    }
...
export type FaxSendingStartedPayloadStatusEnum = "sending" ;
