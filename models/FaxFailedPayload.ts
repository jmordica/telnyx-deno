...
export class FaxFailedPayload {
    ...
    */
    'failureReason'?: FaxFailedPayloadFailureReasonEnum;
    /**
    * The status of the fax.
    */
    'status'?: FaxFailedPayloadStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "FaxFailedPayloadFailureReasonEnum",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "FaxFailedPayloadStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return FaxFailedPayload.attributeTypeMap;
    }
...
export type FaxFailedPayloadFailureReasonEnum = "rejected" ;
export type FaxFailedPayloadStatusEnum = "failed" ;
