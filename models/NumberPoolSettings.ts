...
*/
export class NumberPoolSettings {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "tollFreeWeight",
            "baseName": "toll_free_weight",
            "type": "number",
            "format": ""
        },
        {
            "name": "longCodeWeight",
            "baseName": "long_code_weight",
            "type": "number",
            "format": ""
        },
        {
            "name": "skipUnhealthy",
            "baseName": "skip_unhealthy",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "stickySender",
            "baseName": "sticky_sender",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return NumberPoolSettings.attributeTypeMap;
    }
