...
export class ListMessagingProfilePhoneNumbersResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<PhoneNumberWithMessagingSettings>",
            "format": ""
        },
        {
            "name": "meta",
    ...
    static getAttributeTypeMap() {
        return ListMessagingProfilePhoneNumbersResponse.attributeTypeMap;
    }
