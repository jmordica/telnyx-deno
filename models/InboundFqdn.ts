...
export type InboundFqdn = {
    /**
     * This setting allows you to set the format with which the caller's number (ANI) is sent for inbound phone calls.
     */
    ani_number_format?: InboundFqdn.ani_number_format;
    dnis_number_format?: InboundFqdn.dnis_number_format;
    /**
     ...
     */
    default_routing_method?: InboundFqdn.default_routing_method | null;
    /**
     ...
     */
    sip_region?: InboundFqdn.sip_region;
    /**
     ...
     */
    sip_subdomain_receive_settings?: InboundFqdn.sip_subdomain_receive_settings;
    /**
