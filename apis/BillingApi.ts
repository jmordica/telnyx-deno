...
export class BillingApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getUserBalance(_options?: Configuration): Promise<RequestContext> {
...
export class BillingApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getUserBalance
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserBalance(response: ResponseContext): Promise<GetUserBalance200Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetUserBalance200Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GetUserBalance200Response", ""
            ) as GetUserBalance200Response;
            return body;
        }
